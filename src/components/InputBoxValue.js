...
export default class InputBoxValue extends Component {
	...
	handleInput(event) {
		...
		var modelValue = parseInt(event.target.value)
	...
	render() {
		...
		return (
			<div className={classes + " mdl-textfield mdl-js-textfield mdl-textfield--floating-label"}>
				<input className="mdl-textfield__input" type="text" pattern="-?[0-9]*(\.[0-9]+)?" id={modelId} onInput={this.handleInput.bind(this)} value={this.state.text}/>
