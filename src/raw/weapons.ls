...
weapons = {
  ...
  data: [
    ...
    ["ちゅんちゅん丸",      "sword",  16, 1, 19, 23, 130, 4, "範囲-10 隙が25％短縮"]
    ...
    ["手裏剣",              "kunai",   8, 1, 22, 30, 220, 1, "攻撃速度上昇 6體攻撃"]
    ["スローイングナイフ",  "kunai",  21, 1, 24, 30, 220, 1, "飛行特攻 3體攻撃"]
    ["苦無",                "kunai",  26, 1, 24, 30, 220, 1, "4體攻撃"]
    ["円戦輪",              "kunai",  38, 1, 27, 30, 240, 1, "攻撃速度低下 範圍+20 2體攻撃"]
    ["四方手裏剣",          "kunai",  16, 1, 22, 30, 220, 2, "攻撃速度上昇 6體攻撃"]
    ["ブーメランダガー",    "kunai",  27, 1, 24, 30, 220, 2, "飛行特攻 3體攻撃"]
    ["忍の苦無",            "kunai",  34, 1, 24, 30, 220, 2, "4體攻撃"]
    ["双刃戦輪",            "kunai",  51, 1, 27, 30, 245, 2, "攻撃速度低下 範圍+25 2體攻撃"]
    ["八方手裏剣",          "kunai",  24, 1, 22, 30, 220, 3, "攻撃速度上昇 6體攻撃"]
    ["ウォシュレ",          "kunai",  34, 1, 24, 30, 220, 3, "飛行特攻 3體攻撃"]
    ["十字苦無",            "kunai",  42, 1, 24, 30, 220, 3, "4體攻撃"]
    ["四方戦輪",            "kunai",  63, 1, 27, 30, 250, 3, "攻撃速度低下 範圍+30 2體攻撃"]
    ["月光の短剣",          "kunai",  30, 1, 20, 30, 220, 4, "飛行特攻 3體攻撃 攻撃速度+20%"]
    ["ダマスキナードナイフ", "kunai", 44, 1, 24, 30, 220, 4, "飛行特攻 3體攻撃"]
    ["夜叉の苦無",          "kunai",  55, 1, 24, 30, 220, 4, "4體攻撃"]
    ["白鏡の戦輪",          "kunai",  84, 1, 27, 30, 260, 4, "攻撃速度低下 範圍+40 2體攻撃"]
    ...
    ["六花の水弩",          "xbow",   79, 1, 24, 30, 250, 4, "敵を少し後退させる"]
    ...
    ["白鷺の大筒",          "arqu",   60, 1, 34, 27, 340, 4, "攻撃速度+10% 隙を10%短縮"]
