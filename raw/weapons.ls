...
weapons = {
	...
	data: [
		...
		["魔剣フラガラッハ",	"sword",	72, 1, 19, 30, 190, 4, "範囲+50 敵1體に攻撃"]

		["竹槍",				"lance",	 5, 1, 19, 30, 200, 1, "速度やや上昇"]
		["薙刀",				"lance",	 8, 1, 23, 30, 200, 1, "防禦+5"]
		["長柄鎌",				"lance",	10, 1, 23, 30, 210, 1, "範囲+10"]
		["直槍",				"lance",	13, 1, 23, 30, 200, 1, ""]
		["裂空の真槍",			"lance",	14, 1, 19, 30, 200, 2, "速度やや上昇"]
		["陣中槍",				"lance",	26, 1, 23, 30, 200, 2, ""]
		["名槍ロン",			"lance",	13, 1, 23, 30, 200, 3, "耐久+400"]
		["雙龍槍",				"lance",	26, 1, 19, 30, 200, 3, "速度やや上昇"]
		["片鎌槍",				"lance",	33, 1, 20, 30, 200, 3, "速度若干上昇"]
		...
		["桜花爛漫槍",			"lance",	30, 1, 19, 30, 210, 4, "範囲+10 速度やや上昇"]
		["とんぼきり",			"lance",	31, 1, 23, 30, 220, 4, "範囲+20"]
		["蜻蛉切",				"lance",	35, 1, 19, 30, 200, 4, "速度やや上昇"]
		...
		["木槌",				"hammer",	 6, 1, 18, 30, 100, 1, "速度上昇"]
		["棍棒",				"hammer",	28, 1, 27, 30, 100, 1, ""]
		["金棒",				"hammer",	27, 1, 27, 30, 110, 2, "範囲+10"]
		["戦鎚",				"hammer",	41, 1, 27, 30, 100, 2, ""]
		["神木の槌",			"hammer",	54, 1, 27, 30, 100, 3, ""]
		["義弘の暴槌",			"hammer",	73, 1, 42, 30, 100, 3, "速度低下"]
		["打ち出の小槌",		"hammer",	44, 1, 18, 30, 100, 4, "速度上昇"]
		["軍配形天守槌",		"hammer",	54, 1, 22, 30, 100, 4, "速度やや上昇"]
		["鬼の金棒",			"hammer",	60, 1, 27, 30, 110, 4, "範囲+10"]
		["源翁鎚",				"hammer",	74, 1, 27, 30, 100, 4, ""]
		["真・義弘の暴槌",		"hammer",  100, 1, 42, 30, 100, 4, "速度低下"]
		...
		["柳葉",				"bow",		 9, 1, 17, 18, 280, 1, "速度若干上昇"]
		["破壊の弓",			"bow",		11, 1, 19, 18, 280, 1, ""]
		["重藤の弓",			"bow",		14, 1, 16, 18, 280, 2, "速度やや上昇"]
		["破魔弓",				"bow",		15, 1, 19, 18, 290, 2, "範囲+10"]
		["雷の弓",				"bow",		20, 1, 17, 18, 280, 2, "速度若干上昇"]
		["炎の弓",				"bow",		23, 1, 19, 18, 280, 2, ""]
		["天鹿児弓",			"bow",		24, 1, 16, 18, 280, 3, "速度やや上昇"]
		["光義の弓",			"bow",		26, 1, 19, 18, 300, 3, "範囲+20"]
		["殲滅の猛弓",			"bow",		32, 1, 19, 18, 285, 3, "範囲+5"]
		["為朝の弓",			"bow",		34, 1, 19, 18, 280, 3, ""]
		["元就の謀弓",			"bow",		 3, 1, 69, 18, 280, 3, "速度低下 敵3体に攻撃"]
		["天の羽々矢",			"bow",		29, 1, 15, 18, 280, 4, "速度上昇"]
		["桜花爛漫弓",			"bow",		31, 1, 16, 18, 290, 4, "範囲+10 速度やや上昇"]
		["聚楽の弓",			"bow",		35, 1, 16, 18, 280, 4, "速度やや上昇"]
		["雷上動",				"bow",		40, 1, 17, 18, 280, 4, "速度若干上昇"]
		["弓張月",				"bow",		43, 1, 19, 18, 290, 4, "範囲+10"]
		["梓弓",				"bow",		45, 1, 19, 18, 280, 4, ""]
		["真‧元就の謀弓",		"bow",		12, 1, 69, 18, 280, 4, "速度低下 敵3体に攻撃"]

		["連弩",				"xbow",		18, 1, 42, 30, 250, 2, "敵2体に攻撃"]
		["木弩",				"xbow",		10, 1, 19, 30, 250, 1, "速度やや上昇"]
		["石弩",				"xbow",		28, 1, 24, 30, 250, 1, ""]
		["東方弩",				"xbow",		54, 1, 24, 30, 250, 2, ""]
		["高虎の忠弩",			"xbow",		35, 1, 24, 30, 270, 3, "敵の移動速度を少し下げる"]
		["舞鶴",				"xbow",		55, 1, 20, 30, 250, 3, "速度やや上昇"]
		["近衛の弩",			"xbow",		72, 1, 24, 30, 270, 3, "範囲+20"]
		["正則の剛弩",			"xbow",		84, 1, 38, 30, 250, 3, "速度低下"]
		["わたぬき千狐",		"xbow",		 5, 1, 24, 30, 250, 4, ""]
		["多賀柵弩",			"xbow",		14, 1, 57, 30, 270, 4, "敵3体に攻撃 範囲+20"]
		["無雙弩",				"xbow",		27, 1, 57, 30, 250, 4, "敵3体に攻撃"]
		["真‧高虎の忠弩",		"xbow",		51, 1, 24, 30, 270, 4, "敵の移動速度を少し下げる"]
		["龍髭の弩",			"xbow",		83, 1, 24, 30, 270, 4, "範囲+20"]
		["床子弩",				"xbow",		96, 1, 24, 30, 250, 4, ""]
		["真‧正則の剛弩",		"xbow",	   113, 1, 38, 30, 250, 4, "速度低下"]


		["手銃",				"arqu",		 4, 1, 31, 30, 340, 1, "速度やや上昇"]
		["鉄砲",				"arqu",		15, 1, 37, 30, 360, 1, "範囲+20"]
		["木砲",				"arqu",		19, 1, 37, 30, 350, 1, "範囲+10"]
		["紅蓮の小筒",			"arqu",		25, 1, 37, 30, 340, 1, ""]
		["連裝銃",				"arqu",		 8, 1, 82, 30, 340, 2, "敵1體に2連続攻撃"]
		["大筒",				"arqu",		35, 1, 37, 30, 360, 2, "範囲+20"]
		["回転砲",				"arqu",		12, 1, 102, 30, 340, 3, "敵1體に3連続攻撃"]
		["墨縄",				"arqu",		33, 1, 31, 30, 340, 3, "速度やや上昇"]
		["氷結の大筒",			"arqu",		54, 1, 37, 30, 360, 3, "範囲+20"]
		["國友鉄砲",			"arqu",		57, 1, 37, 30, 350, 3, "範囲+10"]
		["雷光の中筒",			"arqu",		50, 1, 32, 30, 340, 3, "速度若干上昇"]
		["信玄砲",				"arqu",		50, 1, 37, 30, 340, 3, "後退距離若干上昇"]
		["天海の鉄砲",			"arqu",		65, 1, 37, 30, 340, 3, ""]
		["三成の烈砲",			"arqu",		70, 1, 62, 30, 340, 3, "速度低下"]
		["滅‧ガトリング砲",		"arqu",		21, 1, 102, 30, 340, 4, "敵1體に3連続攻撃"]
		["桜花爛漫銃",			"arqu",		52, 1, 31, 30, 350, 4, "範囲+10 速度やや上昇"]
		["八咫烏",				"arqu",		58, 1, 31, 30, 340, 4, "速度やや上昇"]
		["雨夜手拍子",			"arqu",		80, 1, 37, 30, 340, 4, ""]
		["真‧三成の烈砲",		"arqu",		96, 1, 62, 30, 340, 4, "速度低下"]

		["木製大砲",			"cannon",	 7, 1, 35, 45, 340, 1, "速度やや上昇"]
		["設置式大筒",			"cannon",	11, 1, 42, 45, 340, 1, ""]
		["芝辻砲",				"cannon",	16, 1, 35, 45, 340, 2, "速度やや上昇"]
		...
		["小十郎の響杖",		"spell",	22, 1, 34, 30, 240, 3, "速度やや上昇"]
		["三蔵法師の杖",		"spell",	28, 1, 42, 30, 260, 3, "範囲+20"]
		["閻魔の筆",			"spell",	36, 1, 42, 30, 240, 3, ""]
		["真・小十郎の響杖",	"spell",	31, 1, 34, 30, 240, 4, "速度やや上昇"]
		["菩薩の杖",			"spell",	37, 1, 42, 30, 260, 4, "範囲+20"]
		["道風の筆",			"spell",	42, 1, 36, 30, 240, 4, "速度若干上昇"]
		...
		["浮城の鈴",			"bell",		20, 1, 97, 60, 320, 4, "高島城"]
		["真鍮の鈴",			"bell",		20, 1, 97, 60, 320, 5, "濱田城"]
		["シルバーベル",		"bell",		28, 1, 97, 60, 320, 6, "アンボワーズ城"]
		["シルバーベル",		"bell",		28, 1, 97, 60, 320, 6, "城塞都市ルクセンブルク"]
		["海辺の風鈴",			"bell",		28, 1, 97, 60, 320, 6, "［夏］指月伏見城"]
		["太平の鈴",			"bell",		28, 1, 97, 60, 320, 6, "新田金山城"]
		["金の鈴",				"bell",		35, 1, 97, 60, 320, 7, "指月伏見城"]

		["銀の杖",				"staff",	25, 1, 37, 30, 240, 4, "アイリーン・ドナン城"]
		["荊棘の杖",			"staff",	28, 1, 37, 30, 240, 6, "ユッセ城"]
		["荊棘の箒",			"staff",	28, 1, 37, 30, 240, 6, "［ハロウィン］ユッセ城"]
		["クリスタルの杖",		"staff",	28, 1, 37, 30, 240, 6, "ホーエンザルツブルク城"]
		["クリスタルの杖",		"staff",	28, 1, 37, 30, 240, 6, "シュノンソー城"]
		["クリスタルの杖",		"staff",	28, 1, 37, 30, 240, 6, "セゴビアのアルカサ"]
		["女神の杖",			"staff",	35, 1, 37, 30, 240, 7, "プラハ城"]
	]
}
