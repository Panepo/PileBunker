...
weapons = {
	slotWeapon: <[name type atk hit frame1 frame2 range rare text]>
	data: [
		...
		["小十郎の響杖",		"spell2",	22, 1, 34, 30, 240, 3, "速度やや上昇"]
		["三蔵法師の杖",		"spell",	28, 1, 42, 30, 260, 3, "範囲+20"]
		["閻魔の筆",			"spell",	36, 1, 42, 30, 240, 3, ""]
		["真・小十郎の響杖",	"spell2",	31, 1, 34, 30, 240, 4, "速度やや上昇"]
		["菩薩の杖",			"spell",	37, 1, 42, 30, 260, 4, "範囲+20"]
		["道風の筆",			"spell1",	42, 1, 36, 30, 240, 4, "速度若干上昇"]
