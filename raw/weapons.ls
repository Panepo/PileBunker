...
weapons = {
	...
	data: [
		...
		["木槌",				"hammer",	 6, 1, 18, 30, 100, 1, "攻撃速度+30%"]
		...
		["打ち出の小槌",		"hammer",	44, 1, 18, 30, 100, 4, "攻撃速度+30%"]
		["軍配形天守槌",		"hammer",	54, 1, 22, 30, 100, 4, "攻撃速度+20%"]
		...
		["ｼｭﾃﾌｧﾝの闘盾",		"shield",	10, 1, 24, 30, 110, 3, "防禦+33 範囲+20"]
		["プリトウェン",		"shield",	15, 1, 24, 30,  90, 3, "防禦+44"]
		["アキレウスの盾",		"shield",	20, 1, 24, 30,  90, 3, "防禦+37"]
		["真‧ｼｭﾃﾌｧﾝの闘盾",		"shield",	15, 1, 24, 30, 110, 4, "防禦+43 範囲+20"]
		["ちょこしぃるど",		"shield",	21, 1, 24, 30,  90, 4, "防禦+30 回復+3"]
		["アイアースの盾",		"shield",	23, 1, 24, 30,  90, 4, "防禦+48 耐久+300 "]
		...
		["昌景の赤弓",			"bow",		13, 2, 37, 18, 280, 3, "速度低下 2連攻撃"]
		...
		["雷光の中筒",			"arqu",		50, 1, 32, 30, 340, 3, "攻撃速度+10%"]
		...
		["國崩し",				"cannon",	45, 1, 36, 45, 340, 4, "攻撃速度+10%"]
		...
		["小十郎の響杖",		"spell",	22, 1, 34, 30, 240, 3, "攻撃速度+20%"]
		["三蔵法師の杖",		"spell",	28, 1, 42, 30, 260, 3, "範囲+20"]
		["閻魔の筆",			"spell",	36, 1, 42, 30, 240, 3, ""]
		["真・小十郎の響杖",	"spell",	31, 1, 34, 30, 240, 4, "攻撃速度+20%"]
		["菩薩の杖",			"spell",	37, 1, 42, 30, 260, 4, "範囲+20"]
		["道風の筆",			"spell",	42, 1, 36, 30, 240, 4, "攻撃速度+10%"]
