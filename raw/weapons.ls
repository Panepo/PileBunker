...
weapons = {
  ...
  data: [
    ...
    ["氏康の獅盾",          "shield", 44, 1, 42, 30,  90, 3, "防禦+29 防御を10%無視 速度低下"]
    ["桜花爛漫盾",          "shield", 14, 1, 20, 30, 100, 4, "防禦+41 範囲+10 攻撃速度+20%"]
    ...
    ["真・氏康の獅盾",      "shield", 59, 1, 42, 30,  90, 4, "防禦+37 防御を10%無視 速度低下"]

    ["手裏剣",              "kunai",   8, 1, 24, 30, 220, 1, "範囲内の敵6体に攻撃"]
    ["苦無",                "kunai",  26, 1, 24, 30, 220, 1, "範囲内の敵4体に攻撃"]
    ["四方手裏剣",          "kunai",  16, 1, 24, 30, 220, 2, "範囲内の敵6体に攻撃"]
    ["忍の苦無",            "kunai",  34, 1, 24, 30, 220, 2, "範囲内の敵4体に攻撃"]
    ["八方手裏剣",          "kunai",  24, 1, 24, 30, 220, 3, "範囲内の敵6体に攻撃"]
    ["十字苦無",            "kunai",  42, 1, 24, 30, 220, 3, "範囲内の敵4体に攻撃"]
    ["夜叉の苦無",          "kunai",  55, 1, 24, 30, 220, 4, "範囲内の敵4体に攻撃"]
    ...
    ["高虎の忠弩",          "xbow",   35, 1, 24, 30, 250, 3, "敵の移動速度を少し下げる"]
    ...
    ["真・高虎の忠弩",      "xbow",   51, 1, 24, 30, 250, 4, "敵の移動速度を少し下げる"]
    ["桜花爛漫弩",          "xbow",   57, 1, 20, 30, 260, 4, "範囲+10 攻撃速度+20%"]
    ["緋鯉の弩",            "xbow",   55, 1, 24, 30, 250, 4, "巨大化の気を5%軽減"]
    ...
    ["連裝銃",              "arqu",    8, 2, 82, 30, 340, 2, "2連攻撃"]
    ["大筒",                "arqu",   35, 1, 37, 30, 360, 2, "範囲+20"]
    ["氏郷の燕砲",          "arqu",    8, 3, 102, 30, 340, 3, "3連攻撃"]
    ["回転砲",              "arqu",   12, 3, 102, 30, 340, 3, "3連攻撃"]
    ...
    ["真・氏郷の燕砲",      "arqu",   14, 3, 102, 30, 340, 4, "3連攻撃"]
    ["滅・ガトリング砲",    "arqu",   21, 3, 102, 30, 340, 4, "3連攻撃"]
